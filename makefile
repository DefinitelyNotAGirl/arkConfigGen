...
app:  $(OBJECTS_asm_asm) $(OBJECTS_asm_s) $(OBJECTS_cpp_cpp) $(OBJECTS_cpp_cxx) $(OBJECTS_c_c)
	@$(LD) $(OBJECTS_asm_asm) $(OBJECTS_asm_s) $(OBJECTS_cpp_cpp) $(OBJECTS_cpp_cxx) $(OBJECTS_c_c) -o configGen -L lib/ -lcargparse
	$(info  	$(LD)	$@)
